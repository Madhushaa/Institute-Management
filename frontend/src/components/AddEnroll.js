...
{/*
                <div className="form-group" style={{marginBottom:'15px'}}>
            <label  htmlFor="subject" style={{marginBottom:'5px'}}><b> Subject name</b></label>
            <select className="custom-select mr-sm-2" name="subject" onChange = {this.handleInputChange}>
